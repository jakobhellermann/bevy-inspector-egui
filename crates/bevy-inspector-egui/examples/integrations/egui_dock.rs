...
use bevy_inspector_egui::bevy_egui::{EguiContext, EguiContextPass, EguiContextSettings};
...
// TODO: remove this once it is not broken
...
fn handle_pick_events(
    ...
    mut click_events: EventReader<PointerInput>,
